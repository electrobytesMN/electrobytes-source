...
//! These need to be macros, as clientversion.cpp's and electrobytes*-res.rc's voodoo requires it
...
/**
 * electrobytesd-res.rc includes this file, but it cannot cope with real c++ code.
