    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  electrobytes-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the electrobytes in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XBX, 0.1 XBX, 1 XBX and 10 XBX -- sort of like the paper money you use every day.</li> \
