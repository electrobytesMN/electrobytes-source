    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XBX-light"), QVariant("light"));
    ui->theme->addItem(QString("XBX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XBX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XBX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XBX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XBX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XBX-traditional"), QVariant("trad"));
