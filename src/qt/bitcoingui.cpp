...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a electrobytes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and electrobytes: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about electrobytes Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your electrobytes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified electrobytes addresses"));
    ...
    openAction->setStatusTip(tr("Open a electrobytes: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible electrobytes command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to electrobytes network", "", count));
    } else {
...
{
    QString strTitle = tr("electrobytes Core"); // default title
    ...
    // Append title to "electrobytes Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
