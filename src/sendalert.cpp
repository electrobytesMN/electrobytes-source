...
2. run electrobytesd with -printalert or -sendalert like this:
   /path/to/electrobytesd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.electrobytes.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/electrobytes Core:0.12.0.58/"));
