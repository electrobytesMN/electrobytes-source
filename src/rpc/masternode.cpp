...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print electrobytes address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "electrobytes",               "masternode",             &masternode,             true,  {} },
    { "electrobytes",               "masternodelist",         &masternodelist,         true,  {} },
    { "electrobytes",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "electrobytes",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "electrobytes",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "electrobytes",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
