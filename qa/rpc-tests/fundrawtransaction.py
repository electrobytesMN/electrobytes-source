...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid electrobytes address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid electrobytes address" in e.error['message'])
