...
This mechanism has been integrated into Bitcore-Node-electrobytes which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/electrobytespay/insight-api-electrobytes#web-socket-api](https://github.com/electrobytespay/insight-api-electrobytes#web-socket-api)
* API: [https://github.com/electrobytespay/insight-api-electrobytes#instantsend-transactions](https://github.com/electrobytespay/insight-api-electrobytes#instantsend-transactions)
...
By default, the electrobytes Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the electrobytes Core daemon:
